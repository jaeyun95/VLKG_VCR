...
class ConceptCapLoaderTrain(object):
    ...
    def __init__(
        ...
        if dist.is_available() and local_rank != -1:
            ...
            lmdb_file = os.path.join(corpus_path, "gqa_resnext152_faster_rcnn_genome.lmdb")
...
class ConceptCapLoaderRetrieval(object):
    ...
    def __init__(
        ...
        lmdb_file = "/media/ailab/jaeyun/UNITER/img_db/gqa//gqa_resnext152_faster_rcnn_genome.lmdb"
