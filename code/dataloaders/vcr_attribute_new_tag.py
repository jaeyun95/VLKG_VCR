...
class VCR(Dataset):
    def __init__(self, split, mode, only_use_relevant_dets=True, add_image_as_a_box=True, embs_to_load='bert_da',
        ...
        self.tag_feature_path = os.path.join('/media/ailab/songyoungtak/vcr_new/tab_vcr/attribute_features/', f'attribute_features_{self.split}.h5')

        # load non-tag related stuff
        print ('loading non tag image features')
        self.non_tag_feature_path = os.path.join('/media/ailab/songyoungtak/vcr_new/tab_vcr/new_tag_features/', f'new_tag_features_{self.split}.h5')
