...
class VCR(Dataset):
    def __init__(self, split, mode, only_use_relevant_dets=True, add_image_as_a_box=True, embs_to_load='bert_da',
        ...
        ############## here
        self.h5fn = os.path.join(VCR_ANNOTS_DIR, 'vlversion','res101_vcr','annotation', f'vl_{self.embs_to_load}_{self.mode}_{self.split}.h5')
        ...
        ############## here
        self.tag_feature_path = os.path.join(VCR_ANNOTS_DIR, 'vlversion','res101_vcr','image', f'vl_features_{self.mode}_{self.split}.h5')
